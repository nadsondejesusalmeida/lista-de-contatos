export function renderCards(contacts, local, message) {
	...
	contacts.forEach(contact => {
		...
		iconBox.style.backgroundColor = iconBoxColors[Math.floor(Math.random() * iconBoxColors.length)];
